    ...
    public class MenuState : State
    {
        ...
        public override void LoadContent()
        {
            ...
            _components = new List<Component>()
            {
                ...
                {
                    Layer = 0.0f, // 0 because we want the bottom layer
                    Position = new Microsoft.Xna.Framework.Vector2(Game1.ScreenWidth/2, Game1.ScreenHeight/2) // centre of screen
                },
                    new Button(buttonTexture, buttonFont)
                    {
                        Text = "1 Player",
                        Position = new Microsoft.Xna.Framework.Vector2(Game1.ScreenWidth/2, 400),
                ...
                new Button(buttonTexture, buttonFont)
                    {
                        Text = "2 Player",
                        Position = new Microsoft.Xna.Framework.Vector2(Game1.ScreenWidth/2, 440),
                ...
                new Button(buttonTexture, buttonFont)
                    {
                        Text = "Highscores",
                        Position = new Microsoft.Xna.Framework.Vector2(Game1.ScreenWidth/2, 480),
                ...
                new Button(buttonTexture, buttonFont)
                    {
                        Text = "Quit",
                        Position = new Microsoft.Xna.Framework.Vector2(Game1.ScreenWidth/2, 520),

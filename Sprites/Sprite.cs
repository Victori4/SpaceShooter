...
namespace SpaceShooter.Sprites
{
    public class Sprite : Component, ICloneable
    {
        ...
        // layer, origin, pos and scale turned into full properties so we can assign animation manager 
        // prevents things from going out of sync
        // ex: if mySprite._layer = 0.5, will also set it for animationManager
        ...
        // creating a rectangle based on Texture and pos - origin or animation
        ...
        // what we use for rotation per pixel
        ...
        // only check per pixel if enter collision area
        // invisible box around each sprite to detect if they are colliding
        ...
        // constructor taking in animations dictionary
        ...
        // draw texture of animationManager
        ...
        {
            // cannot collide if no texture there
            if (this.TextureData == null)
                return false;
            // if spritie is animated, not doing per pixel collision detection
        ...
        public object Clone()
        {
            ...
            if (_animations != null)
            {
                // shallow clone , don't want to ref same animation anymore, just want new instance
